 ...
 * <pre>
 *  $handle = new Ey_Upload($_FILES['image_field']);
 *  if ($handle->uploaded) {
...
class Emedia_Upload {
     ...
     */
    function Ey_Upload($file, $lang = 'en_ES') {
        ...
        $this->translation['file_error']                  = 'Error de transmisión. Por favor, inténtalo de nuevo.';
        $this->translation['local_file_missing']          = 'El archivo local no existe.';
        $this->translation['local_file_not_readable']     = 'El archivo local no se puede leer.';
        $this->translation['uploaded_too_big_ini']        = 'Error al cargar el archivo (el archivo cargado excede la directiva upload_max_filesize en php.ini).';
        $this->translation['uploaded_too_big_html']       = 'Error al cargar el archivo (el archivo cargado excede la directiva MAX_FILE_SIZE que se especificó en el formulario html).';
        $this->translation['uploaded_partial']            = 'Error al cargar el archivo (el archivo sólo fue cargado parcialmente).';
        $this->translation['uploaded_missing']            = 'Error al cargar el archivo (el archivo no se ha cargado).';
        $this->translation['uploaded_unknown']            = 'Error al cargar el archivo (código de error desconocido).';
        $this->translation['try_again']                   = 'Error al cargar el archivo. Por favor, inténtalo de nuevo.';
        $this->translation['file_too_big']                = 'Archivo demasiado grande.';
        $this->translation['no_mime']                     = 'MIME type no se pueden detectar.';
        $this->translation['incorrect_file']              = 'Tipo de archivo incorrecto.';
        $this->translation['image_too_wide']              = 'La imagen es demasiado ancha.';
        $this->translation['image_too_narrow']            = 'La imagen es demasiado estrecha.';
        $this->translation['image_too_high']              = 'La imagen es demasiado alta.';
        $this->translation['image_too_short']             = 'La imagen es demasiado corta.';
        $this->translation['ratio_too_high']              = 'El ratio es demasiado alto (imagen demasiado ancha).';
        $this->translation['ratio_too_low']               = 'El ratio es demasiado bajo (imagen demasiado alta).';
        $this->translation['too_many_pixels']             = 'La image tiene demasiados píxeles.';
        $this->translation['not_enough_pixels']           = 'La imagen no tiene bastantes pixeles.';
        $this->translation['file_not_uploaded']           = 'El archivo no fue transmitido. Imposible continuar.';
        $this->translation['already_exists']              = '%s ya existe. Por favor, cambie el nombre del archivo.';
        $this->translation['temp_file_missing']           = 'El archivo fuente es incorrecta. Imposible continuar.';
        $this->translation['source_missing']              = 'El archivo transmitido es incorrecto. Imposible continuar.';
        $this->translation['destination_dir']             = 'El directorio de destino no puede ser creado. Imposible continuar.';
        $this->translation['destination_dir_missing']     = 'El directorio de destino no existe. Imposible continuar.';
        $this->translation['destination_path_not_dir']    = 'El path especifivado no es un directorio. Imposible continuar.';
        $this->translation['destination_dir_write']       = 'Directorio de destino, no se puede hacer editable. Imposible continuar.';
        $this->translation['destination_path_write']      = 'EL path de destino no tinee permisos de escritura o no puede ser abierto. Imposible continuar.';
        $this->translation['temp_file']                   = 'No se puede crear el archivo temporal. Imposible continuar.';
        $this->translation['source_not_readable']         = 'El archivo fuente no es legible. Imposible continuar.';
        $this->translation['no_create_support']           = 'Creación desde un archivo %s imposible..';
        $this->translation['create_error']                = 'Error en la creación de la imagen %s desde el código fuente.';
        $this->translation['source_invalid']              = 'Imposible leer la imagen fuente. ¿Es una imagen?.';
        $this->translation['gd_missing']                  = 'GD no parece estar presente.';
        $this->translation['watermark_no_create_support'] = 'Creación desde un archivo %s imposible, watermark no puede ser leído.';
        $this->translation['watermark_create_error']      = 'Error en el momento de la creación del watermark %s desde el archivo fuente.';
        $this->translation['watermark_invalid']           = 'Imposible leer el watermark, formato de archivo desconocido.';
        $this->translation['file_create']                 = 'Creación de un archivo %s imposible.';
        $this->translation['no_conversion_type']          = 'No se define el tipo de conversión.';
        $this->translation['copy_failed']                 = 'Error al copiar el archivo en el servidor. copy() ha fallado.';
        $this->translation['reading_failed']              = 'Error al leer el archivo.';
