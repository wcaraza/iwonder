<?php /* Smarty version 2.6.26, created on *strftime("%Y-%m-%d %H:%M:%S")
         compiled from contactenos/contactenosContent.tpl */ ?>
<?php echo '
...
/images/contactenos/tit_contact.png" alt="" /></h1>
        <div>
            <form id="contactForm" name="contactForm" action="<?php echo $this->_tpl_vars['baseRoot']; ?>
/contactenos/items/sendformcontact" method="post">
                <div class="row">
...
/images/contactenos/img-contactenos.png" height="436" />
	</div>
</div>