<?php /* Smarty version 2.6.26, created on *strftime("%Y-%m-%d %H:%M:%S")
         compiled from productos/productos2Content.tpl */ ?>
...
" <?php if ($this->_tpl_vars['css'] == $this->_tpl_vars['producto'][$this->_sections['pro']['index']]['key']): ?>class="active"<?php endif; ?>><?php echo $this->_tpl_vars['producto'][$this->_sections['pro']['index']]['nombre']; ?>
</a></li>
        <?php endfor; endif; ?>
        </ul>
    </div>
...
" rel="shadowbox; width=884px; height=496px;"><img src="<?php echo $this->_tpl_vars['model']->imagen_frente_chica; ?>
" alt="" /> <?php echo $this->_tpl_vars['model']->nombre; ?>
</a></li>
        <?php else: ?>
        <li><a href="<?php echo $this->_tpl_vars['baseRoot']; ?>
/productos/<?php echo $this->_tpl_vars['css']; ?>
/detalle-modelo/<?php echo $this->_tpl_vars['model']->key; ?>
" rel="shadowbox; width=884px; height=496px;"><img src="<?php echo $this->_tpl_vars['baseRoot']; ?>
/images/slides.png" title="No se encontro la imagen" /> <?php echo $this->_tpl_vars['model']->nombre; ?>
</a></li>
        <?php endif; ?>
   <?php endforeach; endif; unset($_from); ?>
    </ul>
    <div id="navigation"><input name="models" type="hidden" value="<?php echo $this->_tpl_vars['css']; ?>
" id="models"/>
    	<ul class="clearfix">
